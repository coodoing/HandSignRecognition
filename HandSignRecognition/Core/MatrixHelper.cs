...
namespace HandSignRecognition.Core
{
    ...
    /// Description: 操作矩阵的类 MatrixHelper
    /// </summary>
    public class MatrixHelper
    {
         ...
         * @param nCols - 指定的矩阵列数
         */
        public MatrixHelper(int nRows, int nCols)
        {
            numRows = nRows;
            numColumns = nCols;
            Init(numRows, numColumns);
         ...
         */
        public MatrixHelper(double[,] value)
        {
         ...
         */
        public MatrixHelper(int nRows, int nCols, double[] value)
        {
            numRows = nRows;
            numColumns = nCols;
            Init(numRows, numColumns);
         ...
         */
        public MatrixHelper(int nSize, double[] value)
        {
            numRows = nSize;
            numColumns = nSize;
            Init(nSize, nSize);
         ...
         * @param other - 源矩阵
         */
        public MatrixHelper(MatrixHelper other)
        {
         ...
         * @return Matrix对象
         */
        public static MatrixHelper operator +(MatrixHelper m1, MatrixHelper m2)
        {
            return m1.Add(m2);
        }
         ...
         * @return double[]对象
         */
        public static implicit operator double[](MatrixHelper m)
        {
            return m.elements;
        }
         ...
         * @param bFormatted -是否格式化字符串
         * @return string 型，转换得到的字符串
         */
        public string ToString(string sDelim, bool bLineBreak, bool bFormatted)
        {
            string s = "";
            string ss = "";
            for (int i = 0; i < numRows; ++i)
            {
                ...
                {
                    if (bFormatted)
                        ss = GetElement(i, j).ToString("######.00000##");
                    else
                        ss = GetElement(i, j).ToString("F");
                    s += ss;
         ...
         */
        public MatrixHelper SetValue(MatrixHelper other)
        {
            if (other != this)
            {
        ...
        {
            MatrixHelper matrix = other as MatrixHelper;
            if (matrix == null)
                return false;
        ...
        public MatrixHelper Add(MatrixHelper other)
        {
            ...
            // 构造结果矩阵
            MatrixHelper result = new MatrixHelper(this);		// 拷贝构造
         ...
         * @如果矩阵的行/列数不匹配，则会抛出异常
         */
        public MatrixHelper Subtract(MatrixHelper other)
        {
            if (numColumns != other.GetNumColumns() ||
                numRows != other.GetNumRows())
                throw new Exception("矩阵的行/列数不匹配。");
         ...
         */
        public MatrixHelper Multiply(double value)
        {
            // 构造目标矩阵
            MatrixHelper result = new MatrixHelper(this);		// copy ourselves
        ...
        public MatrixHelper Multiply(MatrixHelper other)
        {
            ...
            MatrixHelper result = new MatrixHelper(numRows, other.GetNumColumns());
         ...
         */
        public bool Multiply(MatrixHelper AR, MatrixHelper AI, MatrixHelper BR, MatrixHelper BI, MatrixHelper CR, MatrixHelper CI)
        {
            // 首先检查行列数是否符合要求
            ...
            // 构造乘积矩阵实部矩阵和虚部矩阵
            MatrixHelper mtxCR = new MatrixHelper(AR.GetNumRows(), BR.GetNumColumns());
            MatrixHelper mtxCI = new MatrixHelper(AR.GetNumRows(), BR.GetNumColumns());
            // 复矩阵相乘
        ...
        {
            // 构造目标矩阵
            MatrixHelper Trans = new MatrixHelper(numColumns, numRows);
         ...
         * @return bool型，求逆是否成功
         */
        public bool InvertGaussJordan(MatrixHelper mtxImag)
        {
            int i, j, k, l, u, v, w;
            double p, q, s, t, d, b;
         ...
         * @return bool型，求解是否成功
         */
        public bool SplitLU(MatrixHelper mtxL, MatrixHelper mtxU)
        {
            int i, j, k, w, v, ll;
         ...
         * @return bool型，求解是否成功
         */
        public bool SplitQR(MatrixHelper mtxQ)
        {
            int i, j, k, l, nn, p, jj;
            double u, alpha, w, t;
         ...
         * @return bool型，求解是否成功
         */
        public bool SplitUV(MatrixHelper mtxU, MatrixHelper mtxV, double eps)
        {
         ...
         * @return bool型，求解是否成功
         */
        public bool InvertUV(MatrixHelper mtxAP, MatrixHelper mtxU, MatrixHelper mtxV, double eps)
        {
            int i, j, k, l, t, p, q, f;
         ...
         * @return bool型，求解是否成功
         */
        public bool MakeSymTri(MatrixHelper mtxQ, MatrixHelper mtxT, double[] dblB, double[] dblC)
        {
            int i, j, k, u;
            double h, f, g, h2;
         ...
         * @return bool型，求解是否成功
         */
        public bool ComputeEvSymTri(double[] dblB, double[] dblC, MatrixHelper mtxQ, int nMaxIt, double eps)
        {
            int i, j, k, m, it, u, v;
         ...
         * @return bool型，求解是否成功
         */
        public bool ComputeEvJacobi(double[] dblEigenValue, MatrixHelper mtxEigenVector, int nMaxIt, double eps)
        {
         ...
         * @return bool型，求解是否成功
         */
        public bool ComputeEvJacobi(double[] dblEigenValue, MatrixHelper mtxEigenVector, double eps)
        {
            int i, j, p, q, u, w, t, s;
